                                ...
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Last Name: </b> {{ $applyForMembershipMail->last_name }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>First Name: </b> {{ $applyForMembershipMail->first_name }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Birth Date: </b> {{ $applyForMembershipMail->birth_date }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Birth City: </b> {{ $applyForMembershipMail->birth_city }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Nationality: </b> {{ $applyForMembershipMail->nationality }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Email: </b> {{ $applyForMembershipMail->email }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Phone Number: </b> {{ $applyForMembershipMail->phone_number }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Publications: </b> {!! $applyForMembershipMail->publications !!}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Years of Experience: </b> {{ $applyForMembershipMail->experience_years }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;" class="list-item-first">
                                            <b>Subject of Experience: </b> {{ $applyForMembershipMail->experience_subjects }}
                                        </li>
										<li style="margin:0 0 10px 30px;">
                                            <b>City of Residence: </b> {{ $applyForMembershipMail->residence_city }}
                                        </li>
                                        <li style="margin:0 0 10px 30px;">
                                            <b>References: </b> {!! $applyForMembershipMail->references !!}
                                        </li>
									</ul>
                                    <p style="margin: 0;">
                                        {!! $applyForMembershipMail->content !!}
                                    </p>
                                </td>
                            </tr>
                        </table>
